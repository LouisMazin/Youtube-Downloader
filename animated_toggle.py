...
class AnimatedToggle(QCheckBox):
    ...
    def __init__(self,
        parent=None,
        bar_color="#4f5b62",
        checked_color="#4f5b62",
        handle_color="#ffd740",
        pulse_unchecked_color="#4f5b62",
        pulse_checked_color="#4f5b62"
        ):
        ...
        self._handle_brush = QBrush(QColor(handle_color).darker(120))
        self._handle_checked_brush = QBrush(QColor(handle_color).darker(120))
